...
class WorkflowEdgeCasesTest < ActiveSupport::TestCase
  ...
  # ==========================================================================
  # Scenario 4: Edge Cases - Invalid Condition Format
  # ==========================================================================

  test "invalid condition format fails validation" do
    workflow = Workflow.new(
      title: "Invalid Condition Workflow",
      user: @user,
      steps: [
        {
          "id" => "step-1",
          ...
          "title" => "Bad Decision",
          "branches" => [
            { "condition" => "x === 'yes'", "path" => "Next Step" }
          ]
        },
        {
          "id" => "step-2",
  ...
  test "valid condition formats are accepted" do
    ...
    valid_conditions.each do |condition|
      workflow = Workflow.new(
        title: "Valid Condition Workflow",
        user: @user,
        steps: [
          {
            "id" => "step-1",
  ...
  # ==========================================================================
  # Scenario 5: Error Conditions - Non-existent Step Reference
  # ==========================================================================

  test "decision referencing non-existent step fails validation" do
    workflow = Workflow.new(
      ...
      steps: [
        {
          ...
          "title" => "Decision",
          "branches" => [
            { "condition" => "var == 'yes'", "path" => "Missing Step" }
          ]
        },
        {
          "id" => "step-2",
      ...
      steps: [
        {
          ...
          "title" => "Decision",
          "branches" => [
            { "condition" => "var == 'yes'", "path" => "Existing Step" }
          ],
          "else_path" => "Missing Step"
        },
        {
          "id" => "step-2",
          "type" => "action",
  ...
  test "else_path referencing non-existent step fails validation without branches" do
    # This tests the fix: else_path should be validated even when branches is empty
    workflow = Workflow.new(
      title: "Bad Else Path No Branches Workflow",
      user: @user,
      steps: [
        {
          "id" => "step-1",
  ...
  # ==========================================================================
  # Scenario 5: Error Conditions - Infinite Loop Detection
  # ==========================================================================

  test "infinite loop triggers max iterations error" do
    workflow = Workflow.create!(
      title: "Loop Workflow",
      user: @user,
      steps: [
    ...
    # Execute should handle the infinite loop
