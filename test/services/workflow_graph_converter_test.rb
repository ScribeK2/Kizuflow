...
class WorkflowGraphConverterTest < ActiveSupport::TestCase
  ...
  test "converts decision step branches to transitions" do
    workflow = Workflow.create!(
      title: "Decision Conversion",
      user: @user,
      graph_mode: false,
      steps: [
    ...
    assert_equal 3, decision_step['transitions'].length
  ...
  test "converts legacy decision format" do
    workflow = Workflow.create!(
      ...
      steps: [
        { 'id' => 'a', 'type' => 'question', 'title' => 'Q1', 'question' => 'Yes?', 'variable_name' => 'answer' },
        { 'id' => 'b', 'type' => 'decision', 'title' => 'Decision', 'condition' => "answer == 'yes'", 'true_path' => 'Yes Action', 'false_path' => 'No Action' },
        { 'id' => 'c', 'type' => 'action', 'title' => 'Yes Action', 'instructions' => 'Yes' },
        { 'id' => 'd', 'type' => 'action', 'title' => 'No Action', 'instructions' => 'No' }
      ]
    )
