...
class WorkflowParsers::CsvParserTest < ActiveSupport::TestCase
  # ============================================================================
  ...
  test "returns error for malformed CSV" do
    ...
    assert_nil result
    assert parser.errors.any?, "Should have at least one error"
  end
  ...
  test "returns error for CSV with header row but no data rows" do
    ...
    assert_nil result
    assert parser.errors.any?, "Should have at least one error for empty CSV"
  end
