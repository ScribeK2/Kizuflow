...
class WorkflowWizardFlowTest < ActionDispatch::IntegrationTest
  ...
  # ==========================================================================
  # Decision Step with Variables Test
  # ==========================================================================

  test "wizard creates working decision workflow with variables" do
    draft = Workflow.create!(
      ...
      steps: [
        ...
        },
        {
          ...
          "title" => "Route",
          "branches" => [
            { "condition" => "is_urgent == 'yes'", "path" => "Urgent Action" }
          ],
          "else_path" => "Normal Action"
        },
        {
          "id" => "step-3",
          "type" => "action",
          "title" => "Urgent Action",
          "instructions" => "Handle urgently!"
        },
        {
          "id" => "step-4",
          "type" => "action",
          "title" => "Normal Action",
          "instructions" => "Handle normally"
        }
      ]
    )
