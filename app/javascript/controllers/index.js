...
import YesNoBranchController from "./yes_no_branch_controller"
...
const controllers = [
  ...
  { Controller: CollapsibleStepController, name: "collapsible-step" },
  { Controller: DarkModeController, name: "dark-mode" },
  { Controller: FileAttachmentController, name: "file-attachment" },
  { Controller: InlineStepCreatorController, name: "inline-step-creator" },
  ...
  { Controller: StepOutlineController, name: "step-outline" },
  { Controller: StepSelectorController, name: "step-selector" },
  ...
  { Controller: YesNoBranchController, name: "yes-no-branch" },
]
